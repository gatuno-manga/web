...
export class ChapterService {
	...
	markManyAsRead(chapterIds: string[]) {
		return this.http.post<BatchReadResult[]>(
			'chapters/batch/read',
			chapterIds,
		);
	}
	...
	markManyAsUnread(chapterIds: string[]) {
		return this.http.post<BatchReadResult[]>(
			'chapters/batch/unread',
			chapterIds,
		);
	}

	getChaptersBatch(chapterIds: string[]) {
		return this.http.post<Chapter[]>('chapters/batch/data', chapterIds);
	}
}
