import { Component, input, ElementRef, viewChild, AfterViewInit, ChangeDetectionStrategy, effect } from '@angular/core';
...
export class BlurhashComponent implements AfterViewInit {
  ...
  private render() {
    ...
    try {
      ...
      const decodeHeight = widthValue && heightValue 
        ? Math.round(32 * (heightValue / widthValue))
        : 32;

      const pixels = decode(hashValue, decodeWidth, decodeHeight, this.punch());
